...
#if !defined(SD_SCLK_PIN)
#define SD_SCLK_PIN 27
#endif
#if !defined(SD_MOSI_PIN)
#define SD_MOSI_PIN 28
#endif
...
#define SD_CS_PIN 29
#endif
#if !defined(SD_CS_GPIOHS_NUM)
#define SD_CS_GPIOHS_NUM 29
#endif

/* Configure SPI interface */
#if !defined(SD_SPI)
#define SD_SPI SPI_DEVICE_1
#endif
#if !defined(SD_SPI_CS_NUM)
#define SD_SPI_CS_NUM SPI_CHIP_SELECT_1
#endif
#if !defined(SD_SPI_DMA_CH)
#define SD_SPI_DMA_CH DMAC_CHANNEL0
#endif
#if !defined(SD_SPI_CLK_HIGH_RATE)
